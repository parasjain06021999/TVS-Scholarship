...
export default function CreateScholarshipPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/scholarships', {
        method: 'POST',
        headers: {
      ...
      <div className="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mt-2">Fill in the details to create a new scholarship program</p>
          </div>
