    ...
    for (const scholarshipData of sampleData.scholarships) {
        const scholarship = await prisma.scholarship.create({
            data: {
                ...
                maxAmount: scholarshipData.amount * 1.2,
...
async function createApplications(students, scholarships) {
...
async function createPayments(applications) {
...
async function createNotifications(users, applications) {
